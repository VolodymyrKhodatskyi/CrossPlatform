...
namespace Lab5.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(Auth0Authentication auth0Authentication)
        {
            _auth0Authentication = auth0Authentication;
        }
        [HttpGet]
        ...
        public async Task<IActionResult> Registration(RegistrationViewModel model)
        {
            ...
            try
            {
                await _auth0Authentication.CreateUserAsync(model);
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            ...
            try
            {
                ProfileViewModel userProfile = await _auth0Authentication.GetUser(model);
